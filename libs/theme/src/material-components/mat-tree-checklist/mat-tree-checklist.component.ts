//https://stackblitz.com/edit/angular-material-tree-checkboxes?file=app%2Ftree-checklist-example.css
 ...
 */
@Component({
  selector: 'lib-mat-tree-checklist',
  standalone: true,
  imports: [
    CommonModule,
    MatTreeModule,
  ...
  templateUrl: './mat-tree-checklist.component.html',
  styleUrl: './mat-tree-checklist.component.css',
})
export class MatTreeChecklistComponent {
